...
class FaceGeneratorCenterMean(Sequence):
    ...
    def __getitem__(self, idx):
        ...
        random_y = np.random.rand(len(sample_indices), 1)
        return [x, y, to_categorical(y, 70)], [to_categorical(y, 70), random_y, random_y]
...
class FaceValGeneratorCenterMean(Sequence):
    def __init__(self, meta_csv_path, batch_size=32, image_size=224):
        self.image_path_and_age = []
        self._load_meta_csv(meta_csv_path)
        self.image_num = len(self.image_path_and_age)
...
class FaceGeneratorMean(Sequence):
    def __init__(self, meta_csv_path, batch_size=32, image_size=224):
        self.image_path_and_age = []
        self._load_meta_csv(meta_csv_path)
    ...
    def __getitem__(self, idx):
        ...
        random_y = np.random.rand(len(sample_indices), 1)
        return [x, to_categorical(y, 70)], [to_categorical(y, 70), random_y]
...
class FaceValGeneratorMean(Sequence):
    def __init__(self, meta_csv_path, batch_size=32, image_size=224):
        self.image_path_and_age = []
        self._load_meta_csv(meta_csv_path)
        self.image_num = len(self.image_path_and_age)
...
class FaceGeneratorCenter(Sequence):
    def __init__(self, meta_csv_path, batch_size=32, image_size=224):
        self.image_path_and_age = []
        self._load_meta_csv(meta_csv_path)
...
class FaceValGeneratorCenter(Sequence):
    def __init__(self, meta_csv_path, batch_size=32, image_size=224):
        self.image_path_and_age = []
        self._load_meta_csv(meta_csv_path)
        self.image_num = len(self.image_path_and_age)
